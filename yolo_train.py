...
model = YOLO('yolo26x.pt')  # Options: yolo26n.pt, yolo26s.pt, yolo26m.pt, yolo26x.pt
# model2 = YOLO('yolo26x.pt')  # Options: yolo26n.pt, yolo26s.pt, yolo26m.pt, yolo26x.pt
# DATA_FOLDER = "/Users/michaelmandiberg/Documents/takingstock_production/labeled_images_nov19"
...
results = model.train(
    ...
    name='takingstock_steth_testors_yolo26x',  # Experiment name
...
#     data="/Users/michaelmandiberg/Documents/GitHub/taking-stock-yolo/yolo_dataset_mask/data.yaml",  # absolute path
#     epochs=200,
#     imgsz=1024,
#     batch=-1,       # Reduce if you get memory errors
#     name='takingstock_mask_v6_2k_yolo26x',  # Experiment name
#     patience=20,    # Early stopping
#     device='mps',       # mps for Mac with M1/M2/M3 chips, else 'cuda' or 'cpu'
#     workers=8,        # ✅ CPU workers, not GPU cores
#     project='/Users/michaelmandiberg/Documents/GitHub/taking-stock-yolo/runs',  # Save to project directory
